...
class _HadithScreenState extends State<HadithScreen> {
  ...
  final List<Map<String, dynamic>> hadiths = List.generate(
    42,  // 42 hadiths in Nawawi's collection
    (index) => {
      "number": index + 1,
      "name": "Hadith ${index + 1}",
    },
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(_collectionName, style: AppTextStyles.titleText),
      ),
      body: Row(
        children: [
          // Left Panel with Search and Hadith List
          Container(
            width: 250,
          ...
          // Right Panel with Hadith Content
          Expanded(
            child: _isLoading
